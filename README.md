...
6. Откройте проект как vault в Obsidian и передайте агенту первую задачу из [`START-HERE.md`](./template/START-HERE.md).
...
Готовый архив и SHA-256 появляются в `dist`. Тег вида `v0.8.0`, совпадающий с [`VERSION`](./VERSION), автоматически создаёт GitHub Release.
